...
class Command(BaseCommand):
    ...
    def read_pickled_targetdbout(self, pickledir):
        ...
        #pickled_pandas = pd.read_pickle('/Users/Reetu/Documents/Projects/TargetDB_V2/170414/speedtest_pickle/tabular_output.pkl')
    ...
    def write_to_excel(self, writer, new_res_df):
        ...
        worksheet.set_column('K:' + excel_count_cols, 40)
        worksheet.set_column('A:A', None, None, {'hidden': True})# hiding meaningless column created by multiindexing

        header_fmt = workbook.add_format({'font_name': 'Calibri', 'font_size': 15,
        ...
        worksheet.conditional_format('K7:' + excel_count_cols + str(df_count_rows + 3),
